...
async function fetchHardTimesHeadline() {
    try {
        ...
        console.error("Error fetching the HardTimes 5 headline:", error);
        return null;
    }
}
...
async function generateImagesFromHeadline() {
    ...
    if (headline) {
      ...
      try {
        ...
        console.log("Hard Timnes 5 Headline:", directory);
        ...
        fs.writeFileSync('./index.html', $.html());
            console.log("index.html updated with generated image before the Hard Times 5 headline.");
        } catch (error) {
