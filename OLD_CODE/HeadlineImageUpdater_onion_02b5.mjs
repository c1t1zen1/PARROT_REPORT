    ...
    if (headline) {
      ...
      try {
        ...
        fs.writeFileSync('./index2.html', $.html());
            ...
            try {
                const fallbackImageFiles = await generateImageFiles("Headline News Article style, Investigative Parrot wearing a fedora and dressed like a reporter with a notepad");
