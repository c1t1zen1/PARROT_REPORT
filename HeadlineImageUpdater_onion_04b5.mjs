...
async function generateImagesFromHeadline() {
    ...
    if (headline) {
      // console.log("Fetched Onion 3 Headline:", headline);
      try {
        ...
        console.log("Onion 4 Headline:", directory);
        ...
        fs.writeFileSync('./index.html', $.html());
            ...
            try {
                const fallbackImageFiles = await generateImageFiles("Superhero Movie Style, Action posed Parrot wearing a fedora and dressed like a reporter with a notepad");
