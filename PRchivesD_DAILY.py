...
def process_date(date):
    url = f"{base_url}{date.strftime('%d_%m_%Y')}"  # Append indexD.html here
...
def generate_html(data):
    ...
    <body>
    <a href="https://c1t1zen.com/PR/indexD.html">
        <img src="PARROT_NEWS.jpg" alt="Parrot Pete on the Beat" width="200" height="200">
    </a>
    <h1>
        <a href="https://c1t1zen.com/PR/indexD.html">
            <picture>
                <source media="(min-width: 480px)" srcset="PARROT_REPORT2_D.png">
                <source media="(min-width: 1px)" srcset="PR_LOGO2_D.png">
                <img src="PR_LOGO2_D.png" alt="PARROT REPORT">
            </picture>
        </a>
    </h1>
    <div class="container">	
    ...
    for entry in data:
        ...
        link = entry['link'] + "/indexD.html"  # Append indexD.html here
        image = entry['image']

        html_content += f"<h1><a href='{link}' style='color: white; text-decoration: none;'>{date}</a></h1>"
    ...
    with open('archiveD.html', 'w') as file:
