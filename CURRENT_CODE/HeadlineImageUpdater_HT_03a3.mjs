...
async function generateImagesFromHeadline() {
    ...
    if (headline) {
      try {
        ...
        c// Create the DALL·E prompt with the prepend and append strings
        ...
        console.log(`Hard Times 3 Headline: ${sanitizedHeadline}\n`);
        ...
        fs.writeFileSync('./index2.html', $.html());
            console.log(`Updated Hard Times 3 images: ${directory}\n`);
        } catch (error) {
