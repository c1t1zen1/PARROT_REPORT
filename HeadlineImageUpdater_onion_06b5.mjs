...
async function generateImagesFromHeadline() {
    ...
    if (headline) {
      // console.log("Fetched Onion 6 Headline:", headline);
      try {
        ...
        console.log("Onion 6 Headline:", directory);
        ...
        fs.writeFileSync('./index.html', $.html());
            ...
            try {
                const fallbackImageFiles = await generateImageFiles("Magazine cover Style, Proud Strong Parrot wearing a fedora and dressed like a reporter with a notepad");
