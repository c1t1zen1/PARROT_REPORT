...
with open('./template3.html', 'r') as f:
    html = f.read()
...
with open('./indexT.html', 'w', encoding='utf-8') as f:
    f.write(str(soup))
...
subprocess.run(["node", "./HeadlineImageUpdater_HT_Test_Timestamp.mjs"])
subprocess.run(["node", "./datestamp2.js"])
time.sleep(5)
