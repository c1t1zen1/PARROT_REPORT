...
async function fetchHardTimesHeadline() {
    try {
        ...
        console.error("Error fetching the HardTimes 10 headline:", error);
        return null;
    }
}
...
async function generateImagesFromHeadline() {
    ...
    if (headline) {
      ...
      try {
        ...
        console.log("Hard Timnes 10 Headline:", directory);
